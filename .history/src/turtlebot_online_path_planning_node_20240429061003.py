...
from utils_lib.online_planning import StateValidityChecker, move_to_point, compute_path ,compute_path2, wrap_angle ,move_to_point_smooth
class OnlinePlanner:
    ...
    def controller(self, event):
        ...
        if len(self.path) > 0:
            ...
            # TODO: If current waypoint is reached with some tolerance move to the next waypoint. 
                ...
                v ,w = move_to_point_smooth(self.current_pose, self.path[0])
