...
class RRT:
    ...
    def smooth_paths(self): 
        ...
        for i in range(len(self.smoothed_path)-1):
            ...
            path_db = dubins.shortest_path((self.smoothed_path[i].x ,self.smoothed_path[i].y , self.smoothed_path[i].yaw), (self.smoothed_path[i+1].x ,self.smoothed_path[i+1].y , self.smoothed_path[i+1].yaw),)
